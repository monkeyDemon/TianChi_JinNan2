...
_DATASETS = {
   ...
   'jinnan2_train': {
        _IM_DIR:
            _DATA_DIR + '/jinnan2/jinnan2_train',
        _ANN_FN:
            _DATA_DIR + '/jinnan2/annotations/instances_train2014.json'
    },  
    'jinnan2_val': {
        _IM_DIR:
            _DATA_DIR + '/jinnan2/jinnan2_val',
        _ANN_FN:
            _DATA_DIR + '/jinnan2/annotations/instances_val2014.json'
    }, 
    'coco_2014_minival': {
        _IM_DIR:
            _DATA_DIR + '/coco/coco_val2014',
