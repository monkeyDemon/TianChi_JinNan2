...
train_set_path = '/home/homework/zyb/CRT/denseNet/data/base_3w_dataset/train/'
valid_set_path = '/home/homework/zyb/CRT/denseNet/data/base_3w_dataset/validation/'
...
callbacks=[TensorBoard(log_dir=record_save_path), early_stopping, history, checkpoint, reduceLRcallback]  # TODO: add reduce learning rate or not reduceLRcallback
)
