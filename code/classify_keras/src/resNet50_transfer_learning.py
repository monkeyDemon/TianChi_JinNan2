...
parser = argparse.ArgumentParser(description = 'manual to this script',
                ...
                command example:
                python %(prog)s --train_set_path='/media/homework/c4b7dd6d-5a63-40d3-b57e-2c870c014235/DATASET_v3_totrain/train/' --valid_set_    path='/media/homework/c4b7dd6d-5a63-40d3-b57e-2c870c014235/DATASET_v3_totrain/valid/' '''),
                formatter_class = argparse.RawTextHelpFormatter)
parser.add_argument('--weight_load_path', type = str,
                default = './weight/resnet50_weights_tf_dim_ordering_tf_kernels_notop.h5',
...
parser.add_argument('--weight_save_path', type = str,
                default = './weight/resnet50_weights_tf_transfor.h5',
                help = textwrap.dedent('''\
...
parser.add_argument('--category_num', type = int, default = 2,
                help = 'the category num of the classification problem, default is 2')
...
# record_save_dir   the path to save the training record file
...
reduceLRcallback = ReduceLROnPlateau(monitor='val_acc', factor=0.3, patience=5,
